...
-- Índice funcional LOWER(nombre) omitido en H2: la búsqueda insensible a
-- mayúsculas se resuelve con findByNombreIgnoreCase y el volumen de datos
-- en pruebas no lo requiere.
