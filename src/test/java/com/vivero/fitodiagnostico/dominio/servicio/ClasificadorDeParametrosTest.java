...
class ClasificadorDeParametrosTest {
    ...
    private final Especie especie = new Especie("Monstera deliciosa", "costilla de Adán", rangosMonstera());
    ...
    void unaLecturaDeMagnitudSinRangoEnLaEspecieLanza() {
        ...
        Especie especieIncompleta = new Especie("Monstera deliciosa", "costilla de Adán", soloTemperatura);
        ...
        assertThatThrownBy(() -> clasificador.clasificar(especieIncompleta, medicion))
                ...
                .hasMessageContaining("Monstera deliciosa");
    }
    ...
    void clasificaUnaMedicionConUnaSolaMagnitudSinExigirLasDemas() {
        ...
        Especie especieSoloLuz = new Especie("Monstera deliciosa", "costilla de Adán", soloLuz);
    ...
    void unResultadoOptimoNoEstaFueraDeRango() {
        ...
        Especie especieSoloTemp = new Especie("Monstera deliciosa", "costilla de Adán",
